...
function Card({ className, id, firstname, lastname, surname, score, image, poste, pays, show, active }) {
  ...
  //     if (active) {
  //       card.current.className += " active";
  //     } else {
  //       card.current.className = card.current.className.replace("active", "");
  //     }
  //   }
  // }, [active]);

  return show ? <div className={"member-card " + className + (active ? " active" : "")} ref={card}>
    ...
    <div className="card-inner">
      <div className="card-top">
        ...
        <div className="info">
          ...
          <div className="position">{poste}</div>
          <img className="country" src={pays} alt="country" />
        </div>


        <img className="image" src={image} alt="player" />
      </div>
