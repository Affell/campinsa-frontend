    ...
    <>
      <Container className="legal">
        ...
        <p>
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> met à
        ...
        <p>
          ...
          d’être détenues par{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a> pour la gestion
        ...
        <p>
          ...
          du site internet <a href="https://campinsa.fr">https://campinsa.fr</a>{" "}
          l'identité des différents intervenants dans le cadre de sa réalisation
          et de son suivi:
        </p>
        <p>
          <strong>Propriétaire</strong> : Association CAMP'INSA Capital social
          de 0€ Numéro de TVA: FR48924814890 – 56 rue de Paris, Appt 8 59300
          Valenciennes
          <br />
          <strong>Responsable publication</strong> : Vieira Ruben –
          vieira.ruben.sp@gmail.com
          <br />
        ...
        <p>
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> implique
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> sont donc
        ...
        <p>
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a>, qui s’efforcera
          alors de communiquer préalablement aux utilisateurs les dates et
          heures de l’intervention. Le site web{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a> est mis à jour
          régulièrement par{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a> responsable. De
        ...
        <p>
          Le site internet <a href="https://campinsa.fr">https://campinsa.fr</a>{" "}
          a pour objet de fournir une information concernant l’ensemble des
          activités de la société.
          <a href="https://campinsa.fr">https://campinsa.fr</a> s’efforce de
          fournir sur le site{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a> des informations
        ...
        <p>
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> sont données à
          titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a> ne sont pas
        ...
        <p>
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> est hébergé chez
        ...
        <p>
          <a href="https://campinsa.fr">https://campinsa.fr</a> et l’hébergeur
          ...
          et de téléphonie lié notamment à l’encombr/ement du réseau empêchant
          l’accès au serveur.
        </p>
        <h2>5. Propriété intellectuelle et contrefaçons.</h2>
        <p>
          <a href="https://campinsa.fr">https://campinsa.fr</a> est propriétaire
          ...
          : <a href="https://campinsa.fr">https://campinsa.fr</a>.
        </p>
        <p>
        ...
        <p>
          <a href="https://campinsa.fr">https://campinsa.fr</a> agit en tant
          qu’éditeur du site.{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a> est responsable
          de la qualité et de la véracité du Contenu qu’il publie.{" "}
        </p>
        <p>
          <a href="https://campinsa.fr">https://campinsa.fr</a> ne pourra être
          tenu responsable des dommages directs et indirects causés au matériel
          de l’utilisateur, lors de l’accès au site internet{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a>, et résultant
        ...
        <p>
          <a href="https://campinsa.fr">https://campinsa.fr</a> ne pourra
          ...
          l’utilisation du site{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a>. Des espaces
          interactifs (possibilité de poser des questions dans l’espace contact)
          sont à la disposition des utilisateurs.{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a> se réserve le
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> se réserve
        ...
        <p>
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a>, nous collectons
          les données suivantes qui sont indispensables au fonctionnement du
          service&nbsp;, et qui seront conservées pendant une période maximale
          de 0 mois après la fin de la relation contractuelle:
          <br />
          Aucunes
        </p>
        <p>
          <a href="https://campinsa.fr">https://campinsa.fr</a> collecte en
        ...
        <p>
          ...
          sécurité absolue. Si nous prenions connaissance d'une br/èche de la
        ...
        <p>
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> n'est publiée à
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> et de ses droits
          ...
          du site <a href="https://campinsa.fr">https://campinsa.fr</a>.
        </p>
        <h3>Sécurité</h3>
        <p>
          Pour assurer la sécurité et la confidentialité des Données
          Personnelles et des Données Personnelles de Santé,{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a> utilise des
          réseaux protégés par des dispositifs standards tels que par pare-feu,
          la pseudonymisation, l’encryption et mot de passe.{" "}
        </p>
        <h2>9. Liens hypertextes et balises (“tags”) internet</h2>
        <p>
          Le site <a href="https://campinsa.fr">https://campinsa.fr</a> contient
          un certain nombr/e de liens hypertextes vers d’autres sites, mis en
          place avec l’autorisation de{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a>. Cependant,{" "}
          <a href="https://campinsa.fr">https://campinsa.fr</a> n’a pas la
        ...
        <p>
          <a href="https://campinsa.fr">https://campinsa.fr</a> peut employer
        ...
        <p>
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> d’évaluer les
          réponses des visiteurs face au Site et l’efficacité de ses actions
          (par exemple, le nombr/e de fois où une page est ouverte et les
        ...
        <p>
          ...
          l’attention de <a href="https://campinsa.fr">https://campinsa.fr</a>,
        ...
        <p>
          ...
          <a href="https://campinsa.fr">https://campinsa.fr</a> est soumis au
